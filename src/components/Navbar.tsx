...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* Tagline Banner */}
      <div className="sticky top-20 z-40 w-full bg-secondary/60 backdrop-blur-sm border-b border-border/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <p className="py-2 text-center text-xs sm:text-sm tracking-[0.15em] text-foreground/80 font-medium">
            {t("navbar_tagline")}
          </p>
        </div>
      </div>
